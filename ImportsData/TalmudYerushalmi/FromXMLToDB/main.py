...
def get_xml_content_values(massechet_dir_path,halacha,in_mishna,content,massechet_name):
    ...
    for halacha_num in halacha.keys():
        
        massechet_halacha_id = get_massechet_halacha_id(halacha[halacha_num][-1],halacha_num,massechet_name)
